        ...
        <div className="flex flex-col justify-center py-14 md:py-0 relative z-10">
          <div className="text-center md:text-left space-y-6 lg:max-w-[400px]">
            ...
            <motion.p
              ...
              initial="hidden"
              animate="visible"
              className="text-2xl tracking-wide font-sour"
            >
            ...
            >
              Healthy and yummy food for fresh mornging & breakfast. Eat daily
              for good health and mind . Order now and 20% off on your first
              order
            </motion.p>
            <motion.div
